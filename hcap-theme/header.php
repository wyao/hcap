 ...
 <div id="page"<?php if(!is_page_template('page-nosidebar.php')) { ?> class="with-sidebar"<?php } ?>>
  ...
  <div id="header-wrap">
   <div id="header" class="block-content">
	 ...
	 <div class="landmark"><a href="http://www.harvardcollegeinasia.org/partners/bangkok/"><img id="bangkok" src="<?php bloginfo('template_url'); ?>/images/bangkok_black.png"></a></div>
	 ...
	 <div class="img-info" id="bangkok_i"><h3>Bangkok</h3>Chulalongkorn University</div>
